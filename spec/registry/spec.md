...
| ----- | ------------------------------------------------------ | ----------------- |
| 0     | [Ed25519](https://ed25519.cr.yp.to/)                   | [EdDSA](https://datatracker.ietf.org/doc/draft-ietf-jose-fully-specified-algorithms/) [[def:Fully-Specified Algorithms for JOSE and COSE]] |
